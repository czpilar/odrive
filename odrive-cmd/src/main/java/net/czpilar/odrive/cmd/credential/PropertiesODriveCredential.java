...
import net.czpilar.odrive.cmd.exception.PropertiesFileException;
import net.czpilar.odrive.core.credential.impl.AbstractODriveCredential;
...
/**
 * Implementation of oDrive credential using
    ...
    private void saveProperties() {
        try {
            try (FileOutputStream out = new FileOutputStream(propertyFile)) {
                getProperties().store(out, "odrive properties file");
            }
        } catch (IOException e) {
